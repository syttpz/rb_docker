#include "ros2_bridge_node/compression.hpp"


static void compressFile_orDie(auto chunks, int cLevel,
                               int nbThreads)
{
    ...
    /**
     * rather parse in the files, parse in the composite map instead, which
     * stores the sequence and frame_payload
     * apply zstd 
     * 
     */
